...
> Si el doble clic no funciona, abre una terminal en la raíz del proyecto y corre estas dos líneas en consolas separadas:
> **Backend:** `cd backend && python -m venv venv && venv\Scripts\activate && pip install -r requirements.txt && uvicorn app.main:app --port 8000`
