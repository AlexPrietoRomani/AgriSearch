                ...
                {!isEditing ? (
                    <div className="flex items-start justify-between mb-8 bg-slate-900/40 p-8 rounded-3xl border border-slate-800 shadow-xl">
                        ...
                        <div className="flex flex-col gap-3 flex-shrink-0 ml-8">
                            ...
                            {searches.length > 0 && (
                                <a
                                    href={`/graphs?id=${projectId}`}
                                    className="px-6 py-4 bg-amber-500 hover:bg-amber-400 text-slate-950 font-black rounded-2xl shadow-lg shadow-amber-500/20 transition-all flex items-center justify-center gap-3 hover:-translate-y-1"
                                >
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
